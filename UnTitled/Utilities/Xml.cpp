...
namespace Xml
{
	...
	*/
	...
	void GetVector3(XMLElement * element, float * vec)
	{
		Xml::XMLElement* valElement = element->FirstChildElement();
		vec[0] = valElement->FloatText();

		valElement = valElement->NextSiblingElement();
		vec[1] = valElement->FloatText();

		valElement = valElement->NextSiblingElement();
		vec[2] = valElement->FloatText();
	}

	void GetColorByte3(XMLElement * element, float * vec)
	{
		Xml::XMLElement* valElement = element->FirstChildElement();
		vec[0] = valElement->FloatText() / 255.0f;

		valElement = valElement->NextSiblingElement();
		vec[1] = valElement->FloatText() / 255.0f;

		valElement = valElement->NextSiblingElement();
		vec[2] = valElement->FloatText() / 255.0f;
	}
